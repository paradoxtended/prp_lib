-- This code is basically ox_lib context script, everything is copied here, so you don't have to edit anything in ox_lib files
...
function prp.registerContext(context)
...
---@return string?
function prp.getOpenContextMenu() return openContextMenu end

---@param onExit boolean?
function prp.hideContext(onExit) closeContext(nil, nil, onExit) end
